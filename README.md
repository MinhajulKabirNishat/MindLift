...
- **Live Application:** [Click here to visit MindLift](https://mindlift-backend-nishat.onrender.com)
- **Backend API:** [MindLift Server Status](https://mindlift-k010.onrender.com)
...
- **Real-time Matching:** An algorithm that connects "Seekers" and "Listeners" based on shared topics ( _Exam Stress, Career Anxiety_).
